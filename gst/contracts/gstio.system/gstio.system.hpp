...
namespace gstiosystem {
	...
	struct producer_info {
		...
		// explicit serialization macro is not necessary, used here only to improve compilation time
		GSTLIB_SERIALIZE(producer_info, (owner)(total_votes)(producer_key)(is_active)(url)
	...
	struct voter_info {
		...
		// explicit serialization macro is not necessary, used here only to improve compilation time
		GSTLIB_SERIALIZE(voter_info, (owner)(proxy)(producers)(staked)(reward)(last_vote_weight)(proxied_vote_weight)(is_proxy)(reserved1)(reserved2)(reserved3))
	};
